...
public class playerControl : MonoBehaviour
{
    ...
    public KeyCode moveLeft = KeyCode.H;      // Move a raquete para cima
    public KeyCode moveRight = KeyCode.L;    // Move a raquete para baixo
    public float speed = 10.0f;             // Define a velocidade da raquete
    public float boundX = 8.07f;            // Define os limites em X
